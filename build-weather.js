...
const NIET_PUBLICEREN=new Set([
  ".git",".github","api","cloudflare","docs","functions","lib","node_modules","public","scripts",".weather-runtime-source.tmp","README.md",
...
function intern(n){return n.startsWith(".")||/\.(?:key|pem|p12|pfx|md)$/i.test(n)||NIET_PUBLICEREN.has(n)||n.endsWith(".test.js");}
