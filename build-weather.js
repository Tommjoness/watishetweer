...
const NIET_PUBLICEREN=new Set([
  ...
  "build-weather.js","interpretatie-engine.js","interpretatie-engine.test.js","senior-correctness-v2.js","live-polish.css","live-polish-v2.js","product-config.js",
...
if(html.includes("CENTRALE INTERPRETATIE-ENGINE")||html.includes("SENIOR CORRECTHEIDSLAAG")||html.includes("LIVE POLISH")||html.includes("LIVE INTERACTIEPOLISH"))throw new Error("Bron-index bevat een buildlaag al.");
...
const vereist=[
  "WeatherNowInterpretatie","WeatherNowCorrectnessV2","WeatherNowPolishV2","weatherNowActueleLokaleTijd","plaatsTijdDelen","weatherNowZoneOffset",
...
console.log("WeatherNow-build geslaagd: expliciete productconfiguratie, centrale interpretatie, correctheidslaag, live-polish, interactiepolish en cache "+versie+".");
