...
document.addEventListener('DOMContentLoaded',async()=>{const zet=(k,v)=>document.body.setAttribute('data-hour-refine-'+k,String(v));try{
 ...
 S.klokInstantOverride=new Date('2026-09-02T11:27:00Z');S.geo={TI,T:S.d.hourly.temperature_2m,A:S.d.hourly.apparent_temperature,P:S.d.hourly.precipitation_probability,MM:S.d.hourly.precipitation,x:i=>i};S.dag=null;
...
try{
  ...
  console.log(`Desktoprefinement groen op 1600×900: ${basis} volledige uurregels op natuurlijke hoogte en ${groter} na +80px; rijcount is hoogtegestuurd, resterende ruimte wordt gelijkmatig over leesbare rijen verdeeld, grafiek/tabel blijven exact gelijk, paneelhoogtes sluiten aan en er is geen interne scrollbar.`);
