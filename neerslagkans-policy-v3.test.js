...
test("30 en 70 procent krijgen zichtbaar verschillende zekerheid",()=>{
...
test("briefing gebruikt dezelfde grenzen zonder percentages te herhalen",()=>{
  assert.equal(briefingZin({genoeg:true,kans:9,soort:"regen"}),"De komende twee uur blijft het waarschijnlijk droog.");
  assert.equal(briefingZin({genoeg:true,kans:10,soort:"regen"}),"De komende twee uur is er een kleine kans op neerslag.");
  assert.equal(briefingZin({genoeg:true,kans:30,soort:"regen"}),"In de komende twee uur is neerslag mogelijk.");
  assert.equal(briefingZin({genoeg:true,kans:70,soort:"regen"}),"De komende twee uur is er een grote kans op neerslag.");
  assert.equal(briefingZin({genoeg:true,kans:90,soort:"regen"}),"De komende twee uur is de kans op neerslag zeer groot.");
});
