...
const LOCATIES=Object.freeze([
  ...
  {slug:"apeldoorn",naam:"Apeldoorn",provincie:"Gelderland",lat:52.2112,lon:5.9699,seoFocus:true,seoIntro:"Bekijk voor Apeldoorn de actuele temperatuur en weersituatie, wanneer er de komende uren neerslag wordt verwacht en hoe de komende zeven dagen eruitzien. Lokale tijden, luchtkwaliteit en Nachtzicht vullen het overzicht aan."},
  ...
  {slug:"leeuwarden",naam:"Leeuwarden",provincie:"Fryslân",lat:53.2012,lon:5.7999,seoFocus:true,seoIntro:"Het actuele weer in Leeuwarden staat hier samen met de huidige temperatuur, neerslag voor de komende uren en de 7-daagse verwachting. Je vindt er daarnaast lokale tijden, luchtkwaliteit en Nachtzicht voor dezelfde plaats."},
  ...
  {slug:"tilburg",naam:"Tilburg",provincie:"Noord-Brabant",lat:51.5555,lon:5.0913,seoFocus:true,seoIntro:"Voor Tilburg zie je hier het actuele weer en de huidige temperatuur, gevolgd door neerslag voor de komende uren en de 7-daagse verwachting. Lokale tijden, luchtkwaliteit en Nachtzicht staan op dezelfde pagina, zodat je niet tussen losse weerkaarten hoeft te schakelen."},
  {slug:"utrecht",naam:"Utrecht",provincie:"Utrecht",lat:52.0907,lon:5.1214,populair:true,seoFocus:true,seoIntro:"Deze weerpagina voor Utrecht combineert de actuele temperatuur en weersituatie met neerslag voor de komende uren en de 7-daagse verwachting. Ook lokale tijden, luchtkwaliteit en Nachtzicht zijn direct beschikbaar in hetzelfde overzicht."},
