...
assert.equal((verruimCsp(defaultBewerkt).match(/static\.cloudflareinsights\.com\/beacon\.min\.js/g)||[]).length,1,"default-src-fallbackpad moet idempotent zijn");
...
console.log("cloudflare-web-analytics-csp: effectieve scriptdirective, default-src-fallback, onbeperkte noop en idempotentie OK");
