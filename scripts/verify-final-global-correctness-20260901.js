...
for(const p of htmls(OUT)){
  ...
  const eisen=[
    ...
    [s.includes("beleid.nachtVensterStartDatum(venster,avondDatum,zonsondergang)"),"venster na middernacht gebruikt de volgende lokale kalenderdag"],
    [s.includes("const optiesNacht={zonsopkomst:sr"),"kalendernacht voor Nachtzicht"],
