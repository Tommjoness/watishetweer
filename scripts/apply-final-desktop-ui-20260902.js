...
const FOOTER_GAP_NEW="gap:2px 16px!important";
...
function compacteerFooterRuntime(bron){const n=String(bron).split(FOOTER_GAP_OLD).length-1;if(n!==1)throw new Error("Finale desktop-UI footergapanker verwacht exact één keer; gevonden "+n);return String(bron).replace(FOOTER_GAP_OLD,FOOTER_GAP_NEW);}
...
module.exports={OUT,START,MARKER,RUNTIME,PRESSURE_OLD,PRESSURE_NEW,FOOTER_GAP_OLD,FOOTER_GAP_NEW,herstelDrukOwnerRuntime,compacteerFooterRuntime,weerBestand,pasToe,main};
