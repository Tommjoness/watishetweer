...
console.log("UI-polish regressiecontract groen: bronsemantiek, waarschuwingstatus, tijdtaal, cijfers, Q4-ownership, geen dubbele UV-/pollen-owner en accessibility.");