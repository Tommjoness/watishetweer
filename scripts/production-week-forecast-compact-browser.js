...
(async()=>{
  ...
  try{
    for(const scherm of schermen){
      ...
      assert.equal(uit.beschreven,0,`${scherm.naam}: verwijderde dagnotities blijven via aria-describedby gekoppeld`);
      ...
      console.log(`COMPACT WEEK OK ${scherm.naam}: ${uit.dagen} dagen, 0 lange notities, Neerslag-kolom intact.`);
      await context.close();
    }
