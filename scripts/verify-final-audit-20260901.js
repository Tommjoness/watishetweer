...
eis(html.includes("Luchtkwaliteitswaarschuwing"),"Nederlandse NWS-luchtkwaliteitstitel ontbreekt");
eis(html.includes("wiw-more-measurements"),"toegankelijke sectie Meer meetgegevens ontbreekt");
eis(html.includes("Herleid tot zeeniveau zodat luchtdruk tussen locaties vergelijkbaar is."),"zeeniveaubetekenis bij luchtdruk ontbreekt");
