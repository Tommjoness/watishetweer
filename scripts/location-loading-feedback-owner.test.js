...
eis(html.includes('locatieladen-spinner'),"Spinner ontbreekt.");
...
console.log("Location-loading owner: zichtbare geocoder- en forecastfeedback, reduced motion, aria-busy, zero-layout-row en latest-wins guard aanwezig.");
