...
ok(html.includes('perioden.length+" regenperiode"+(perioden.length===1?"":"s")'),"totaalregel gebruikt compacte enkelvoud/meervoudtekst zonder dubbel tijdvak");
ok(html.includes('const piekY=samenvattingY+regel;'),"grafiekhoogte reserveert alleen werkelijk gebruikte bracketlabels vóór het piekuur");
ok(html.includes('Bij iedere regenperiode staan begin- en eindtijd en verwachte hoeveelheid.'),"toegankelijke grafiekuitleg beschrijft de nieuwe bracketlabels");
