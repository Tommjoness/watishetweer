...
ok(html.includes('perioden.length>1&&g.n<=25'),"exacte regenperioderegels blijven beperkt tot de 24-uursweergave");
ok(html.includes('const piekY=samenvattingY+regel*(detailRegels.length+1)'),"grafiekhoogte reserveert alleen werkelijk gebruikte regenperioderegels vóór het piekuur");
