...
assert(css.includes('.chartdata{margin:10px 0 0;min-width:0;max-width:100%;width:100%;box-sizing:border-box;overflow:hidden}'),"chartdata-details moet een echte lokale overflowgrens vormen rond de brede tabel");
...
console.log("Staff-audit pure contracts groen: gecontroleerde warningmapping, geldige history-state, lokale outer containment, horizontaal-only tabelscroll en nul/null-neerslag blijven onderscheiden.");
