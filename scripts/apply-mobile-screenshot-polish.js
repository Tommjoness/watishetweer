...
const copyJs=fs.readFileSync(path.join(__dirname,"final-copy-polish.js"),"utf8");
...
const COPY_MARK="/* ===== FINAL DUTCH COPY ===== */";
const UV_BRIDGE_MARK="/* ===== FINAL UV BRIDGE ===== */";
const MOON_JS_MARK="/* ===== MOON PHASE V3 ===== */";
const START="/* ---------- start ---------- */";
if(html.includes(CSS_MARK)||html.includes(JS_MARK)||html.includes(FINAL_CSS_MARK)||html.includes(FINAL_JS_MARK)||html.includes(COPY_MARK)||html.includes(UV_BRIDGE_MARK)||html.includes(MOON_JS_MARK))throw new Error("Definitieve post-build polish is al geïnjecteerd.");
...
for(const vereist of [
  ...
  "WeatherNowFinalCopy","WeatherNowUvBridge","WeatherNowMoonV3","maan-fase-svg-v3"
]){
