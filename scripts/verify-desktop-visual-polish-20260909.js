...
for(const p of htmlBestanden(OUT)){
  ...
  eis(html.includes('.final-top-grid #t{font-size:60px!important;line-height:.86!important}'),rel+": huidige temperatuur staat niet vast op de bedoelde compacte desktopmaat");
