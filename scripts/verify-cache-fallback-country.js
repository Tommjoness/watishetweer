...
const plaatsOwner=fs.readFileSync(path.join(__dirname,"apply-shared-url-place-identity.js"),"utf8");
...
if(plaatsOwner.includes(oud)||plaatsOwner.includes(nieuw))throw new Error("Shared-URL-owner bevat nog cachefallback-landsemantiek.");
...
if(!plaatsOwner.includes('shared-url-place-identity.js'))throw new Error("Shared-URL-owner assembleert de canonieke plaatsidentiteitsbron niet.");
...
console.log("Locatie-identiteitsartifact geverifieerd: cachefallback-land komt uitsluitend uit product-config/base-build en de afzonderlijke shared-URL-owner injecteert vóór startup uit gevalideerde coördinaten.");
