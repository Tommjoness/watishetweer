...
console.log("Weather fallback artifact: 5s hedge, 10s volledige forecastcap, 5s fallbackcap, 2s acceptancemarge, stale-load guards en eerste-successemantiek aanwezig.");
