...
assert(positie("verify-unified-weather-truth.js")<positie("apply-seo-foundation.js"),"SEO-routes moeten de geconsolideerde productsemantiek erven");
...
console.log("Postbuild-pipeline: exacte volgorde, unified weather truth, SEO-routes, provenance, guards en fail-fast gedrag geslaagd.");
