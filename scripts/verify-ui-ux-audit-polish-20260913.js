...
for(const p of htmlBestanden(OUT)){
  ...
  assert(html.includes('.dashrow-hero .stats .eyebrow{letter-spacing:.075em!important;line-height:1.2!important;min-height:2.4em}'),rel+": lange mobiele metrieklabels missen het rustige kopritme");
