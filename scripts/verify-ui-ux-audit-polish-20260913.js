...
for(const p of htmlBestanden(OUT)){
  ...
  assert(html.includes('html body footer:nth-of-type(n){margin-top:10px!important;padding-top:4px!important;column-gap:12px!important;row-gap:0!important}'),rel+": mobiele footer houdt nog te veel externe/interne bovenruimte");
