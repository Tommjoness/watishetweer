...
for(const p of htmlBestanden(OUT)){
  ...
  assert(html.includes('html body footer:nth-of-type(n){margin-top:6px!important;padding-top:0!important;padding-bottom:0!important;display:grid!important;grid-template-columns:minmax(0,1fr) max-content max-content max-content minmax(0,1fr)!important'),rel+": mobiele footer heeft geen expliciete compacte grid-owner");
  assert(html.includes('footer .bron-bronnen{display:flex!important;flex-wrap:wrap!important;align-items:stretch!important;justify-content:space-between!important;width:100%;column-gap:12px!important;row-gap:0!important')&&html.includes('footer .bron-bronnen .bronlabel{flex:0 0 100%;margin:0!important;text-align:center}'),rel+": mobiele bronlijst benut de breedte niet als gelijkmatig flexritme");
  assert(html.includes('footer .bron-bronnen .bronitem a{display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:44px!important;margin:0!important;padding:0!important}'),rel+": mobiele bronlinks verliezen hun 44px touchdoel of erven oude horizontale spacing");
