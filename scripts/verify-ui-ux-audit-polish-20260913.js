...
for(const p of htmlBestanden(OUT)){
  ...
  assert(html.includes('footer .bron-bronnen .bronitem{min-width:0;border-bottom:1px solid var(--rule-soft)!important}'),rel+": bronregels hebben geen uniforme zachte scheidingslijn");
