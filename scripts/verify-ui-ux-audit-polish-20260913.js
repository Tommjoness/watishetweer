...
for(const p of htmlBestanden(OUT)){
  ...
  assert(html.includes('footer .bron-bronnen{display:grid!important;grid-template-columns:minmax(0,.9fr) minmax(0,1.75fr) minmax(0,1fr) minmax(0,.55fr)!important;align-items:stretch!important;width:100%;column-gap:6px!important;row-gap:0!important')&&html.includes('footer .bron-bronnen .bronlabel{grid-column:1 / -1;margin:0!important;text-align:center}'),rel+": mobiele bronlijst gebruikt niet de gewogen vierkolomsindeling");
