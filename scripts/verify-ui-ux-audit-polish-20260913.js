...
for(const p of htmlBestanden(OUT)){
  ...
  assert(html.includes('@media(max-width:600px){')&&html.includes('.footer-contact-mail{margin-top:-8px}'),rel+": smalle mobielweergave houdt nog te veel visuele ruimte tussen contactvraag en mailregel");
