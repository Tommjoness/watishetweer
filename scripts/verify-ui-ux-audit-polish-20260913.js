...
for(const p of htmlBestanden(OUT)){
  ...
  assert(html.includes('html body footer:nth-of-type(n) > span.bron.bron-bronnen{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;grid-auto-flow:row!important;align-items:stretch!important;width:100%;column-gap:16px!important;row-gap:2px!important')&&html.includes('footer .bron-bronnen .bronlabel{grid-column:1 / -1;margin:0!important;text-align:center}'),rel+": mobiele bronlijst heeft geen harde 2-koloms row-flow override op de late runtime-flexowner");
