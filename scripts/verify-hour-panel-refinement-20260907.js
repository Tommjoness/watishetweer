...
for(const p of htmlBestanden(OUT)){
  ...
  eis(/\.wiw-hour-table td\{[\s\S]*?padding-top:1px!important;[\s\S]*?padding-bottom:1px!important;[\s\S]*?line-height:14\.5px!important/.test(html),`${rel}: compacte desktop-uurrij ontbreekt`);
...
console.log(`Uurpaneelrefinement geverifieerd op ${geraakt} weerartifacts: maximaal 17 desktopuren, compacte leesbare uurrijen, actuele Nu-context behouden, 0 mm blijft 0 mm, desktop-CSS staat actief in head, masthead/SEO-inhoud hebben veilige insets en Nachtzicht gebruikt brede ruimte.`);
