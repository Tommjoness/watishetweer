...
for(const p of htmlBestanden(OUT)){
  ...
  eis(/@media\(min-width:1366px\)\{[\s\S]*?\.wiw-chart-main\{min-height:340px!important\}[\s\S]*?\.wiw-hour-table td\{padding:calc\(1\.25px \+ var\(--wiw-hour-row-pad-extra,0px\)\) 4px!important\}/.test(html),`${rel}: gekoppelde 1366px-desktop mist de minimale hoogte of subpixelveiligheidsmarge voor acht volledige leesbare uurregels`);
