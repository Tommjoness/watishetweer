...
for(const p of htmlBestanden(OUT)){
  ...
  eis(/@media\(min-width:1360px\)\{[\s\S]*?\.wiw-hour-table td\{[\s\S]*?padding:calc\(1px \+ var\(--wiw-hour-row-pad-extra,0px\)\) 4px!important/.test(html)&&/@media\(min-width:1360px\) and \(max-width:1499px\)\{[\s\S]*?#wiw-hour-panel h3\{margin-bottom:5px!important\}[\s\S]*?\.wiw-hour-table th\{padding:3px 4px!important\}/.test(html),`${rel}: compacte 1360px desktopspacing voor de 1363px productiegate ontbreekt`);
