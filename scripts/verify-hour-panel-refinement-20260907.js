...
for(const p of htmlBestanden(OUT)){
  ...
  eis(html.includes('const gewensteMinimumUren=window.innerWidth>=1440?10:8;')&&html.includes('const minimumUren=Math.min(gewensteMinimumUren,Math.floor((beschikbareRijhoogte+0.5)/29),tbody&&tbody.children.length||0);'),`${rel}: 1440px tienurenhorizon of smallere achturenvloer respecteert de 29px-leesbaarheidsvloer niet`);
