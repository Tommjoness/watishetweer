...
const {
  OUT,OUD,NIEUW,PLAATSINGSANKER,FALLBACKANKER,htmlBestanden
...
function main(){
  ...
  console.log(`Temperatuur-labelcontract OK op ${gecontroleerd} weergrafiek-artifacts: boven is voorkeur, onder alleen fallback.`);
}
