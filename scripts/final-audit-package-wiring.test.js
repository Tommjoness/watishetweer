...
for(const stap of ["node scripts/final-audit-20260901.test.js","node scripts/apply-final-audit-20260901.js","node scripts/verify-final-audit-20260901.js"]){assert(pkg.scripts.test.includes(stap),"npm test mist "+stap);}
for(const stap of ["node scripts/apply-final-audit-20260901.js","node scripts/verify-final-audit-20260901.js"]){assert(pkg.scripts.postbuild.includes(stap),"npm postbuild mist "+stap);}
...
console.log("Finale audit is correct aangesloten op test- en postbuildketen.");
