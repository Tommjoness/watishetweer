...
for(const p of htmlBestanden(OUT)){
  ...
  assert.ok(html.includes('const nieuwH=Math.max(basisH,laatsteBedragY+(compactDesktop?15:25));'),rel+": viewBox-onderreserve gebruikt niet het compacte desktopcontract");
  gezien++;
}
